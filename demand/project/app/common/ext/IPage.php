...
class IPage{
    ...
    private $config  = array(
        ...
        'first'  => '首页',
        'last'   => '末页',
        'theme'  => '当前第<b>%NOW_PAGE%</b>页，共<b>%TOTAL_PAGE%</b>页  %FIRST% %UP_PAGE% %LINK_PAGE% %DOWN_PAGE% %END%&nbsp;&nbsp;共<b>%TOTAL_ROW%</b>条数据',
    );
     ...
     * @param string $type  分页类别【‘loan' 银行 ‘credit’信用卡】
     */
    public function __construct($totalRows, $listRows=10, $parameter = array(), $type = 'loan') {
        /* 基础设置 */
    ...
    private function url($page){
        return str_ireplace(urlencode('[PAGE]'), $page, $this->url);
    }
    ...
    public function show() {
        ...
        switch ($this->type){
            case 'loan':
                $this->url = get_pc_loan_search( $this->parameter);
                break;
            case 'credit':
                $this->url = get_pc_credit_search( $this->parameter);
