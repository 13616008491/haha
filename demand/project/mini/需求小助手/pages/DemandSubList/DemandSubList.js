...
Page({
  ...
  initData() {
    //获取列表信息
    api.list.demand_list({
    project_id:this.data.project_id, 
    demand_status: this.data.demand_status, 
    bottom_id: this.data.demand_id }, e => {
      ...
      if (e.demand_list.length == 10) {
        this.data.demand_id = e.demand_list[9].demand_id;
      } else {
  ...
  commit(e) {
    ...
    wx.navigateTo({
      url: '/pages/Compose/Compose?target_id=' + project_id,
    })
  },
