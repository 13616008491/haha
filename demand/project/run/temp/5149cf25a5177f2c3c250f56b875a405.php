<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/phpstudy/www/demand/public/../project/app/admin/view/admin/admin_info.html";i:1549957977;s:74:"/phpstudy/www/demand/public/../project/app/admin/view/layout_menu_all.html";i:1549957979;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="container">
                ...
                <div class="cont mt10">
                    ...
                    <div class="lists">
                        ...
                        <!--添加用户表单-->
<div class="tab_edit">
    <form action="<?php echo Url('admin_info_submit'); ?>" method="post" id="admin_info_submit">
        <input type="hidden" name="admin_id" value="<?php echo get_login_admin_id(); ?>"/>
        <table width="100%" class="list">
            <tr>
                <td class="t_r t_left_w">登录账户：</td>
                <td class="t_l"><?php echo $admin_info['phone']; ?></td>
            </tr>
            <tr>
                <td class="t_r t_left_w">真实姓名：</td>
                <td class="t_l"><?php echo widget('common/Input/input',array('real_name',$admin_info['real_name'],true)); ?></td>
            </tr>
            <tr>
                <td class="t_r t_left_w">最后登录时间：</td>
                <td class="t_l"><?php echo $admin_info['login_time']; ?></td>
            </tr>
            <tr>
                <td class="t_r t_left_w">最后登录IP：</td>
                <td class="t_l"><?php echo $admin_info['login_ip']; ?></td>
            </tr>
            <tr>
                <td class="t_r t_left_w">注册时间：</td>
                <td class="t_l"><?php echo $admin_info['reg_time']; ?></td>
            </tr>
            <tr>
                <td class="t_r t_left_w">最后登录IP：</td>
                <td class="t_l"><?php echo $admin_info['reg_ip']; ?></td>
            </tr>
            <tr>
                <td class="t_r t_left_w">二维码：</td>
                <td class="t_l">  <?php echo widget('common/Images/img',array($mini_code,200,200)); ?><span style="color:red;"><?php echo $qr_error; ?></span></td>
            </tr>
            <tr>
...
<script type="text/javascript">
    $(function(){
        if('<?php echo $show_reset; ?>'){
            alert('当前登录密码为默认密码，请修改密码');
        }
    })
