<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/phpstudy/www/demand/public/../project/app/admin/view/project/project_list.html";i:1549957980;s:74:"/phpstudy/www/demand/public/../project/app/admin/view/layout_menu_all.html";i:1549957979;}*/ ?>
<!DOCTYPE html>
...
<div class="c-head-box">
    ...
    <ul>
        <li class="c-head-search">
            <!-- 搜索条件 -->
            <ul>
                <li><span>项目编号：</span><input type="text" name="project_id" value="<?php echo $project_id; ?>"/></li>
                <li><span>项目名称：</span><input type="text" name="project_name" value="<?php echo $project_name; ?>"/></li>
                <li><span>负责人姓名：</span><input type="text" name="user_name" value="<?php echo $user_name; ?>"/></li>
            </ul>
        </li>
    ...
    <div class="lists-table">
        <table class="pointer" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                ...
                <th style="width: 3%" class="tabSort-header"><a class="tabSort-header-inner"><p>开放状态</p></a></th>
                <th style="width: 3%" class="tabSort-header"><a class="tabSort-header-inner"><p>负责人</p></a></th>
                <th style="width: 3%" class="tabSort-header"><a class="tabSort-header-inner"><p>负责人电话</p></a></th>
            ...
            <tbody>
                <?php if(is_array($project_list) || $project_list instanceof \think\Collection || $project_list instanceof \think\Paginator): if( count($project_list)==0 ) : echo "" ;else: foreach($project_list as $key=>$info): ?>
                    <tr>
                        <td><?php echo $info['project_id']; ?></td>
                        <td><?php echo $info['project_name']; ?></td>
                        <td><?php echo widget('common/Images/img' ,array($info['project_photo_url'],25,25)); ?></td>
                        <td><?php echo widget('common/Color/color',array('propose_status',$info["propose_status"])); ?></td>
                        ...
                        <td><?php echo $info['sort_level']; ?></td>
                        <td>
                            <a data-type="info-win" data-src="<?php echo Url('project_info',array('project_id'=>$info['project_id'])); ?>" data-title="详情" data-width="60%" data-height="60%" class="blue">详情</a>
                            <a href="<?php echo Url('project_edit',array('project_id'=>$info['project_id'])); ?>" class="blue">编辑</a>
                        </td>
                    </tr>
