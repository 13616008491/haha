<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/phpstudy/www/demand/public/../project/app/admin/view/allot/demand_task_list.html";i:1549957978;s:74:"/phpstudy/www/demand/public/../project/app/admin/view/layout_menu_all.html";i:1549957979;}*/ ?>
<!DOCTYPE html>
...
<div class="c-head-box">
    <form method="get" action="<?php echo Url('demand_task_list'); ?>">
    <ul>
        <li class="c-head-search">
            ...
            <ul>
                ...
                <li><span>项目状态：</span><?php echo widget('common/Select/select',array('demand_status','demand_status',$demand_status)); ?></li>
        ...
        <li class="c-head-button">
            ...
            <div class="fr"><a class="but_blue" href="<?php echo Url('demand_task_add'); ?>">添加需求外报告</a></div>
        </li>
    </ul>
    </form>
</div>
        ...
        <table class="pointer" cellpadding="0" cellspacing="0" border="0">
            ...
            <tbody>
                <?php if(is_array($demand_list) || $demand_list instanceof \think\Collection || $demand_list instanceof \think\Paginator): if( count($demand_list)==0 ) : echo "" ;else: foreach($demand_list as $key=>$info): ?>
                    <tr>
                        <td><?php echo (isset($info['demand_id']) && ($info['demand_id'] !== '')?$info['demand_id']:'--'); ?></td>
                        <td><?php echo (isset($info['project_name']) && ($info['project_name'] !== '')?$info['project_name']:'--'); ?></td>
                        ...
                        <td><?php echo widget('common/Color/color',array('task_type',$info["task_type"])); ?></td>
                        <td title="<?php echo (isset($info['rate_describe']) && ($info['rate_describe'] !== '')?$info['rate_describe']:'--'); ?>"><?php echo (isset($info['rate_describe']) && ($info['rate_describe'] !== '')?$info['rate_describe']:'--'); ?></td>
                        <td><?php echo $info['rate_percent']; ?>%</td>
