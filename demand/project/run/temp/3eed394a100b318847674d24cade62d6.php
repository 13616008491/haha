<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/phpstudy/www/demand/public/../project/app/admin/view/allot/demand_propose_list.html";i:1549957977;s:74:"/phpstudy/www/demand/public/../project/app/admin/view/layout_menu_all.html";i:1549957979;}*/ ?>
<!DOCTYPE html>
...
<div class="c-head-box">
    <form method="get" action="<?php echo Url('demand_propose_list'); ?>">
    <ul>
        <li class="c-head-search">
            ...
            <ul>
                ...
                <li><span>需求状态：</span><?php echo widget('common/Select/select',array('demand_status','demand_status',$demand_status)); ?></li>
        ...
        <li class="c-head-button">
            ...
            <div class="fr"><a class="but_blue" href="<?php echo Url('demand_add'); ?>">添加需求</a></div>
        </li>
    </ul>
    </form>
</div>
    ...
    <div class="lists-table">
        <table class="pointer" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                ...
                <th style="width: 3%" class="tabSort-header"><a class="tabSort-header-inner"><p>优先级</p></a></th>
                <th style="width: 4%" class="tabSort-header"><a class="tabSort-header-inner"><p>需求状态</p></a></th>
                <th style="width: 5%" class="tabSort-header"><a class="tabSort-header-inner"><p>审核时间</p></a></th>
            ...
            <tbody>
                <?php if(is_array($demand_list) || $demand_list instanceof \think\Collection || $demand_list instanceof \think\Paginator): if( count($demand_list)==0 ) : echo "" ;else: foreach($demand_list as $key=>$info): ?>
                    <tr>
                        ...
                        <td><?php echo (isset($info['auditing_time']) && ($info['auditing_time'] !== '')?$info['auditing_time']:'--'); ?></td>
                        <td><?php echo (isset($info['expect_finish_time']) && ($info['expect_finish_time'] !== '')?$info['expect_finish_time']:'--'); ?></td>
                        <td><?php echo (isset($info['finish_time']) && ($info['finish_time'] !== '')?$info['finish_time']:'--'); ?></td>
                        <td>
